...
AI 기반 작업 운영 체계의 목표는 사용자의 아이디어를 목표 해석, 구조 탐색, 계획, 구현, 검증, 기록, 문서화로 이어지는 통제 가능한 흐름으로 만드는 것이다.
...
AI 기반 작업 운영에서 `기획 / 기술 구현 / QA / 문서화`는 작업 단계다.
...
AI Workflow Index
-> AI Workflow 문서의 위치, 역할, 상태를 확인하는 목차
