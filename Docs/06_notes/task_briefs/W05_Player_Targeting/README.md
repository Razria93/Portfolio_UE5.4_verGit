...
| W05-04 | Player Target Lock Assist v1 | `TB_W05_04_Player_Target_Lock_Assist_v1.md` | 구현 완료 (PIE 검증 대기) |
...
W05 타게팅 작업군은 W05-05까지 순차 구현하고 검증한 뒤 다음 시스템 작업으로 이동한다. W05-03은 C++ 구현과 Development 빌드, 좌우 전환 PIE 검증을 완료했으며 이전 타겟 Destroy 경계 검증만 남겨 두었다. W05-04는 C++ 구현과 Development 빌드를 완료했으며 PIE 검증을 남겨 두었다. W05-05는 작업 시작 전에 별도 Task Brief로 세부 정책과 완료 조건을 고정한다.
