...
| S36 | Execution Collaboration Architecture | `S36_UE5_Portfolio_Execution_Collaboration_Architecture.md` | Source/Target pair session, Standard Execution Down/Recovery, Lethal Death presentation handoff | Current System (target contract; C++ cutover and asset/PIE verification pending) | R08의 구현·검증 기준 |
