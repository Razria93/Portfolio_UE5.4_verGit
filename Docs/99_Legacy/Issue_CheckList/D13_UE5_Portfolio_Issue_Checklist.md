...
**M03-03: Damage Pipeline 공유 구조 구현 및 규칙 정리**
...
- Team / Friendly Fire / Guard / Armor / Resistance 정책은 별도 후속 범위로 분리한다.
...
- Guard / Armor / Resistance 같은 수치 확장 요소는 현재 shared combat core 위에 확장하는 후속 범위로 남김.
