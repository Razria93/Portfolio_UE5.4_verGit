...
#include "CAnimNotifyState_WeaponPivotRotationOverride.generated.h"

UCLASS(meta = (DisplayName = "Weapon Pivot Rotation Override"))
class PORTFOLIO_API UCAnimNotifyState_WeaponPivotRotationOverride : public UCAnimNotifyState_ActionBase
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Weapon Pivot Rotation", meta = (ClampMin = "0.0"))
...
protected:
	...
	void CompleteTransition(class UCWeaponComponent* InWeaponComp, uint32 InTransitionHandle) const;
